...
public class Application extends Thread {
	...
	private static final String THREAD_POOL_CONFIGURATION_FILE_PATH 	= "conf/application/thread-pool.xml";
	...
	private AbstractXmlApplicationContext _threadPoolContext;
			...
			while (run) {
				if (!isStarted || needConfigurationReload()) {
					...
					try {
						...
						logger.info("Chargement du fichier de configuration des ThreadPools : " + THREAD_POOL_CONFIGURATION_FILE_PATH);
						_threadPoolContext = new FileSystemXmlApplicationContext(THREAD_POOL_CONFIGURATION_FILE_PATH);
						addConfigurationFileMD5(THREAD_POOL_CONFIGURATION_FILE_PATH);
