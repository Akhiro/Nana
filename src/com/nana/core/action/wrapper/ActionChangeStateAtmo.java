...
public class ActionChangeStateAtmo extends ActionChangeStateWithApi<Integer, IAPIWeather>{
	public ActionChangeStateAtmo(@NonNull final IState<Integer> state, @NonNull final IAPIWeather iApi) {
		super(state, iApi);
	}
